            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Arrive at the game in luxury with our event transportation.
                    </p>
                </div>

                <div className="max-w-4xl mx-auto">
                    <div className="prose prose-lg mx-auto mb-12">
                        <p>Avoid parking hassles and arrive at sporting events in style. Our chauffeurs will drop you at the entrance and be ready for pickup when the game ends. Available for all major stadiums and arenas.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl mb-12">
                        ...
                        <ul className="grid md:grid-cols-2 gap-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700">Stadium drop-off/pickup</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="h-6 w-6 text-primary mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            ...
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700">Pre/post-game dining options</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="h-6 w-6 text-primary mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-gray-700">Cooler with ice available</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="h-6 w-6 text-primary mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-gray-700">Tailgate packages</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="text-center">
                        ...
                        >
                            Book Sports Event Transportation
                        </Link>
                    </div>
                </div>
            </div>
