            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        Graduations & Proms Transportation
                    </h1>
                    <div className="w-16 h-1 bg-primary mx-auto mb-6"></div>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        Make milestone events memorable with luxury transportation.
                    </p>
                </div>

                <div className="max-w-4xl mx-auto">
                    <div className="prose prose-lg mx-auto mb-12">
                        <p>Our graduation and prom packages include special decorations, photo opportunities, and professional service to make these important events unforgettable. We provide safe transportation for groups of all sizes.</p>
                    </div>
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl mb-12">
                        ...
                        <ul className="grid md:grid-cols-2 gap-4">
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700">Special event decorations</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="h-6 w-6 text-primary mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            ...
                            <li className="flex items-start">
                                ...
                                <span className="text-gray-700">Group packages</span>
                            </li>
                            <li className="flex items-start">
                                <svg className="h-6 w-6 text-primary mr-3 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    ...
                    <div className="text-center">
                        ...
                        >
                            Book Graduation/Prom Transportation
                        </Link>
                    </div>
                </div>
            </div>
